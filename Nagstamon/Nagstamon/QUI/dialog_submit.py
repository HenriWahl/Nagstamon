...
class Ui_dialog_submit(object):
    def setupUi(self, dialog_submit):
        ...
        self.gridLayout.addWidget(self.label_check_output, 3, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.label_performance_data, 5, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.label_comment, 7, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.gridLayout.addLayout(self.horizontalLayout, 10, 0, 2, 4)
