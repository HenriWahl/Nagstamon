...
class Ui_settings_action(object):
    def setupUi(self, settings_action):
        ...
        settings_action.resize(1124, 1197)
        ...
        self.label_help_type = QtWidgets.QLabel(settings_action)
        ...
        self.input_combobox_action_type = QtWidgets.QComboBox(settings_action)
        ...
        self.label_help_string_description = QtWidgets.QLabel(settings_action)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(settings_action)
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.gridLayout.addWidget(self.buttonBox, 25, 6, 1, 1)
        self.input_lineedit_string = QtWidgets.QLineEdit(settings_action)
        ...
        self.label_help_type_description = QtWidgets.QLabel(settings_action)
        ...
        self.label_help_string = QtWidgets.QLabel(settings_action)
        ...
        self.buttonBox.accepted.connect(settings_action.accept)
        self.buttonBox.rejected.connect(settings_action.reject)
    ...
    def retranslateUi(self, settings_action):
        ...
        self.label_help_type.setText(_translate("settings_action", "Help"))
        ...
        self.label_help_string_description.setText(_translate("settings_action", "Available variables for action strings:\n"
"\n"
...
"$TRANSID$ - only useful for Check_MK as _transid=$TRANSID$"))
        self.label_help_type_description.setText(_translate("settings_action", "Available action types:\n"
"\n"
"Browser:\n"
...
""))
        self.label_help_string.setText(_translate("settings_action", "Help"))
