...
class Ui_dialog_downtime(object):
    def setupUi(self, dialog_downtime):
        ...
        dialog_downtime.resize(409, 374)
        ...
        self.input_textedit_comment = QtWidgets.QTextEdit(dialog_downtime)
        self.input_textedit_comment.setTabChangesFocus(True)
        self.input_textedit_comment.setObjectName("input_textedit_comment")
        self.gridLayout.addWidget(self.input_textedit_comment, 1, 0, 1, 5)
