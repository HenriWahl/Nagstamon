...
class Ui_dialog_authentication(object):
    def setupUi(self, dialog_authentication):
        ...
        dialog_authentication.resize(1400, 226)
        dialog_authentication.setMinimumSize(QtCore.QSize(400, 0))
        ...
        self.gridLayout.addWidget(self.label_autologin_key, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_checkbox_use_autologin, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_lineedit_autologin_key, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_checkbox_save_password, 2, 1, 1, 1)
