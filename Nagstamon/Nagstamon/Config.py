...
class Config(object):
    ...
    def __init__(self):
        ...
        self.color_ok_text = "white"
        self.color_ok_background = "darkgreen"
        self.color_warning_text = "black"
        self.color_warning_background = "yellow"
        self.color_critical_text = "white"
        self.color_critical_background = "red"
        self.color_unknown_text = "black"
        self.color_unknown_background = "orange"
        self.color_unreachable_text = "white"
        self.color_unreachable_background = "darkred"        
        self.color_down_text = "white"
        self.color_down_background = "black"
        self.color_error_text = "black"
        self.color_error_background = "lightgrey"
