...
class Ui_settings_server(object):
    def setupUi(self, settings_server):
        ...
        self.groupbox_check_mk_views = QtWidgets.QGroupBox(self.groupbox_options)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupbox_check_mk_views.sizePolicy().hasHeightForWidth())
        self.groupbox_check_mk_views.setSizePolicy(sizePolicy)
        self.groupbox_check_mk_views.setObjectName("groupbox_check_mk_views")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.groupbox_check_mk_views)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.label_check_mk_view_hosts = QtWidgets.QLabel(self.groupbox_check_mk_views)
        self.label_check_mk_view_hosts.setObjectName("label_check_mk_view_hosts")
        self.gridLayout_4.addWidget(self.label_check_mk_view_hosts, 0, 0, 1, 1)
        self.label_check_mk_view_services = QtWidgets.QLabel(self.groupbox_check_mk_views)
        self.label_check_mk_view_services.setObjectName("label_check_mk_view_services")
        self.gridLayout_4.addWidget(self.label_check_mk_view_services, 1, 0, 1, 1)
        self.input_lineedit_check_mk_view_services = QtWidgets.QLineEdit(self.groupbox_check_mk_views)
        self.input_lineedit_check_mk_view_services.setObjectName("input_lineedit_check_mk_view_services")
        self.gridLayout_4.addWidget(self.input_lineedit_check_mk_view_services, 1, 1, 1, 1)
        self.input_lineedit_check_mk_view_hosts = QtWidgets.QLineEdit(self.groupbox_check_mk_views)
        self.input_lineedit_check_mk_view_hosts.setObjectName("input_lineedit_check_mk_view_hosts")
        self.gridLayout_4.addWidget(self.input_lineedit_check_mk_view_hosts, 0, 1, 1, 1)
        self.button_check_mk_view_hosts_reset = QtWidgets.QPushButton(self.groupbox_check_mk_views)
        self.button_check_mk_view_hosts_reset.setObjectName("button_check_mk_view_hosts_reset")
        self.gridLayout_4.addWidget(self.button_check_mk_view_hosts_reset, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.groupbox_check_mk_views, 17, 0, 1, 4)
    ...
    def retranslateUi(self, settings_server):
        ...
        self.groupbox_check_mk_views.setTitle(_translate("settings_server", "Views:"))
        self.label_check_mk_view_hosts.setText(_translate("settings_server", "Hosts:"))
        self.label_check_mk_view_services.setText(_translate("settings_server", "Services:"))
        self.button_check_mk_view_hosts_reset.setText(_translate("settings_server", "Reset"))
        self.button_check_mk_view_services_reset.setText(_translate("settings_server", "Reset"))
