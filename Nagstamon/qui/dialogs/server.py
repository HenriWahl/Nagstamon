...
class DialogServer(Dialog):
    ...
    def __init__(self):
        ...
        self.VOLATILE_WIDGETS = {
            ...
            self.window.label_map_to_disaster: ['Alertmanager'],
            self.window.input_lineedit_map_to_disaster: ['Alertmanager'],
            self.window.label_map_to_high: ['Alertmanager'],
            self.window.input_lineedit_map_to_high: ['Alertmanager'],
            self.window.label_map_to_average: ['Alertmanager'],
            self.window.input_lineedit_map_to_average: ['Alertmanager'],
            self.window.label_map_to_information: ['Alertmanager'],
            self.window.input_lineedit_map_to_information: ['Alertmanager'],
